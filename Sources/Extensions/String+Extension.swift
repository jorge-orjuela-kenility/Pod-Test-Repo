...
extension String {
    ...
    ///
    /// This function attempts to parse the string (represented by `self`) into a `Date` object using the provided date format.
    /// If the format is not specified, it defaults to `"MM-dd-yy"`. The function makes a copy of the date formatter to ensure
